...
const MolStarViewer = ({
    ...
    useEffect(() => {
        (async () => {
            if (useInterface) {
                ...
                plugin.current = await createPluginUI({target: parentRef.current, spec: spec, render: renderReact18});
            } else {
            ...
            setInitialized(true);
            console.log(plugin.current.canvas3d);
        })();
    ...
    }, [pdbId, url, file, plugin.current, initialized])
