                    ...
                    <section id="use-cases">
                        ...
                        <Box component="figure" className="my-4">
                            ...
                            <Typography
                                ...
                                sx={{ mt: 1 }}
                            >
                                Figure XXX. Starting from the geometry given by PEP-EDIT, an ensemble of conformers is generated
                        ...
                        <Typography variant="body1" component="p">
                            ...
                            together with the sequence of protein. The SMILES were generated using the following BILN sequences:{" "}
                        </Typography>
                        ...
                        <Box component="figure" className="my-4">
                            ...
                            <Typography
                                ...
                                sx={{ mt: 1 }}
                            >
                                Figure XXX. Based on the SMILES given by PEP-EDIT (and the sequence of the proteins), both protein-peptide complexes were predicted with AlphaFold 3.
