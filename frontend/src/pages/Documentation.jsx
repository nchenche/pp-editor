...
# (ratio_of_mapped_atoms_to_keep, number_of_attempts)`}
                    ...
                    <section id="use-cases">
                        ...
                        <Typography variant="body1" component="p">
                            ...
                            . For instance, the cyclic peptide orbitide xanthoxycyclin D can be generated in PEP-EDIT using the following BILN sequence:
                        </Typography>
                        ...
                        <Typography variant="body1" component="p">
                            ...
                            allows to start exploring various conformations of orbitide xanthoxycyclin D.
                        ...
                        <Box component="figure" className="my-4">
                            <Box
                                ...
                                alt="Ensemble of conformers generated by ORCA's GOAT algorithm for orbitide xanthoxycyclin D"
                                className="w-full max-w-2xl mx-auto rounded-xl shadow"
                                onClick={() =>
                                    openLightbox(
                                        "/assets/documentation/6wpv_doc.jpg",
                                        "Ensemble of conformers generated by ORCA's GOAT algorithm for orbitide xanthoxycyclin D"
                                    )
                                }
                            />
                            <Typography
                            ...
                            >
                                ...
                                to explore the conformational space of orbitide xanthoxycyclin D. Compared with a reference structure (PDB ID: <code>6WPV</code>), new
                        ...
                        <Typography variant="body1" component="p">
                            PEP-EDIT proves to be a suitable tool for generating initial XYZ coordinates of cyclic and/or modified peptides to be studied further with quantum chemistry methods.
